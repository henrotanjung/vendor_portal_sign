...
class CustomerPortal(CustomerPortal):
    ...
    @http.route(['/my/testing', '/my/purchase/page/<int:page>'], type='http', auth="public", website=True)
    def portal_my_purchase_ordersa(self, page=1, date_begin=None, date_end=None, sortby=None, filterby=None, **kw):
        print ('new testinggggggggggggg')

    @http.route(['/my/purchase/<int:order_id>/accept'], type='json', auth="public", website=True)
    def portal_purchase_quote_accept(self, order_id, access_token=None, name=None, signature=None):
        # get from query string if not on json param
        print ('abccccccccccccccccccccccccc purchases', signature)
        # return
